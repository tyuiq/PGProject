<template>
  <div class="det-frame">
    <div v-if="pageState === 'add'" class="det-add">
      ...
      >
        <el-form-item label="百科标题" prop="title">
          <el-input v-model="formData.title" placeholder="请输入百科标题" class="input-inner"></el-input>
        </el-form-item>
        <el-form-item label="百科内容" prop="content">
          <el-input
            type="textarea"
    ...
    <div v-if="pageState === 'edit'">
      ...
      >
        <el-form-item label="百科标题" prop="title">
          <el-input v-model="dataList.title" placeholder="请输入标题" class="input-inner"></el-input>
        </el-form-item>
        <el-form-item label="百科内容" prop="content">
          <el-input
            type="textarea"
